...
#define CZ_TILD_FIX ALGR(CZ_A)
#define CZ_GRV_FIX ALGR(CZ_SCLN)
#define CZ_CIRC_FIX ALGR(CZ_ZCAR)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NumLayer] = LAYOUT_split_3x6_3(
        CZ_PIPE, CZ_1,         CZ_2,         CZ_3,         CZ_4,         CZ_5,          CZ_6,    CZ_7,         CZ_8,         CZ_9,         CZ_0,            CZ_GRV_FIX,
        KC_ESC,  CZ_EXLM,      CZ_AT,        CZ_HASH,      CZ_DLR,       CZ_PERC,       CZ_CIRC_FIX, CZ_AMPR,      CZ_ASTR,      CZ_BSLS,      CZ_COLN,         CZ_DQUO,
        CZ_UNDS, CZ_TILD_FIX,  CZ_LABK,      CZ_LCBR,      CZ_LBRC,      CZ_LPRN,       CZ_RPRN, CZ_RBRC,      CZ_RCBR,      CZ_RABK,      CZ_QUES,         CZ_QUOT,
    ...
    [NavLayer] = LAYOUT_split_3x6_3(
        ...
        KC_BRID, _______,      _______,      _______,      _______,      KC_CALC,       KC_MPRV, KC_MPLY,      KC_MNXT,      KC_STOP,      _______,         KC_VOLD,

                                           MO(CzechLayer), KC_TAB, KC_SPC,                  KC_BSPC,  KC_ENT,  _______
    ),

     /*
      * TODO: Háčky a čárky u T, O, D a N
      *
      * ┌───┬───┬───┬───┬───┬───┐       ┌───┬───┬───┬───┬───┬───┐
      * │ | │   │ é │ ě │ ř │ T │       │ ý │ ů │ í │ O │   │ + │
      * ├───┼───┼───┼───┼───┼───┤       ├───┼───┼───┼───┼───┼───┤
    ...
    [CzechLayer] = LAYOUT_split_3x6_3(
        CZ_PIPE, _______,      CZ_EACU,      CZ_ECAR,      CZ_RCAR,      UC(357),       CZ_YACU, CZ_URNG,      CZ_IACU,      UC(243),      _______,         CZ_PLUS,
        KC_ESC,  CZ_AACU,      CZ_SCAR,      UC(271),      _______,      _______,       _______, CZ_UACU,      _______,      _______,      _______,         CZ_EQL,
        CZ_UNDS, CZ_ZCAR,      _______,      CZ_CCAR,      _______,      _______,       UC(328), _______,      CZ_ACUT,      CZ_CARN,      _______,         CZ_MINS,
